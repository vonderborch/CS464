 ...
 * TopFunction.
 */
public class TopFunctionTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "TopFunction";
    ...
    private static final TopFunctionTypeSupport _singleton
        = new TopFunctionTypeSupport();
     ...
     */
    public static TopFunctionTypeSupport get_instance() {
        return _singleton;
    }

    public static TopFunctionTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return TopFunction.create();
    }
     ...
     * <code>this</code> is not a <code>TopFunction</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        TopFunction typedDst = (TopFunction) destination;
        TopFunction typedSrc = (TopFunction) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        TopFunction typedSrc = (TopFunction) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.hostname);
            
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.currentTime);
...
TopFunction typedSrc = (TopFunction) src;    
        ...
        dst.writeString(typedSrc.username,(255));
            
        dst.writeString(typedSrc.hostname,(255));
            
        dst.writeString(typedSrc.currentTime,(255));
            
        dst.writeFloat(typedSrc.cpuUsage);        
            
        dst.writeFloat(typedSrc.memUsage);        
            
        dst.writeInt(typedSrc.procNumber);        
...
TopFunction typedDst = (TopFunction) dst;
        
            typedDst.clear();
    try {

            typedDst.username = src.readString((255));
            
            typedDst.hostname = src.readString((255));
            
            typedDst.currentTime = src.readString((255));
            
            typedDst.cpuUsage = src.readFloat();
            
            typedDst.memUsage = src.readFloat();
            
            typedDst.procNumber = src.readInt();
...
TopFunction typedDst = (TopFunction) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
TopFunction typedDst = (TopFunction) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new TopFunctionDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new TopFunctionDataReader(native_reader, listener, mask, this);                
    ...
    protected TopFunctionTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,TopFunctionTypeCode.VALUE,TopFunction.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected TopFunctionTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,TopFunctionTypeCode.VALUE,TopFunction.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
