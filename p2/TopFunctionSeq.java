...
/**
 * A sequence of TopFunction instances.
 */
public final class TopFunctionSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public TopFunctionSeq() {
        super(TopFunction.class);
    }


    public TopFunctionSeq(int initialMaximum) {
        super(TopFunction.class, initialMaximum);
    }


    public TopFunctionSeq(Collection elements) {
        super(TopFunction.class, elements);
    }
