 ...
 * LittleMsg.
 */
public class LittleMsgTypeSupport extends TypeSupportImpl {
    // -----------------------------------------------------------------------
    // Private Fields
    // -----------------------------------------------------------------------

    private static final String TYPE_NAME = "LittleMsg";
    ...
    private static final LittleMsgTypeSupport _singleton
        = new LittleMsgTypeSupport();
     ...
     */
    public static LittleMsgTypeSupport get_instance() {
        return _singleton;
    }

    public static LittleMsgTypeSupport getInstance() {
        return get_instance();
    }

    public Object create_data() {
        return LittleMsg.create();
    }
     ...
     * <code>this</code> is not a <code>LittleMsg</code>
     * type.
     */
    public Object copy_data(Object destination, Object source) {
        LittleMsg typedDst = (LittleMsg) destination;
        LittleMsg typedSrc = (LittleMsg) source;
	...
	Object sample) 
    {
        ...
        long encapsulation_size = currentAlignment;
        LittleMsg typedSrc = (LittleMsg) sample;
        ...
        currentAlignment += CdrPrimitiveType.getStringSerializedSize(currentAlignment, typedSrc.sender);
...
LittleMsg typedSrc = (LittleMsg) src;    
        ...
        dst.writeInt(typedSrc.messagenumber);        
...
LittleMsg typedDst = (LittleMsg) dst;
        
            typedDst.clear();
    try {

            typedDst.messagenumber = src.readInt();
...
LittleMsg typedDst = (LittleMsg) dst;
        ...
        Object endpoint_plugin_qos) 
    {
        ...
        if (deserialize_key) {
LittleMsg typedDst = (LittleMsg) sample;
    ...
    protected DataWriter create_datawriter(long native_writer,
        ...
        return new LittleMsgDataWriter(native_writer, listener, mask, this);                
    ...
    protected DataReader create_datareader(long native_reader,
        ...
        return new LittleMsgDataReader(native_reader, listener, mask, this);                
    ...
    protected LittleMsgTypeSupport() {
        
        /* If the user data type supports keys, then the second argument
        to the constructor below should be true.  Otherwise it should
        be false. */        

        super(TYPE_NAME, false,LittleMsgTypeCode.VALUE,LittleMsg.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    
    }

    protected LittleMsgTypeSupport(boolean enableKeySupport) {
    
        super(TYPE_NAME, enableKeySupport,LittleMsgTypeCode.VALUE,LittleMsg.class,TypeSupportType.TST_STRUCT, PLUGIN_VERSION);
    }
}
