...
/**
 * A sequence of LittleMsg instances.
 */
public final class LittleMsgSeq extends LoanableSequence implements Copyable {
    // -----------------------------------------------------------------------
    // Package Fields
    // -----------------------------------------------------------------------
    ...
    public LittleMsgSeq() {
        super(LittleMsg.class);
    }


    public LittleMsgSeq(int initialMaximum) {
        super(LittleMsg.class, initialMaximum);
    }


    public LittleMsgSeq(Collection elements) {
        super(LittleMsg.class, elements);
    }
